...
def main():
  ...
  demo = SegmentDemo()
  if len(sys.argv) > 1:
      demo.OUTPUT_FILE_NAME = sys.argv[1]
...
class SegmentDemo(object):
  ...
  IMG_TITLE_FONT = 'ARIAL.TTF'#'monaco.ttf'
  IMG_TITLE_HEIGHT = 40

  CHARTS_PER_LINE = 3
  CHART_WIDTH = 158
  CHART_HEIGHT = 250#125
  CHART_MARGIN_TOP = 20
  CHART_MARGIN_LEFT = 20
  CHART_BAR_COLORS = ['F67749', '0F6899', '9EC4D9','429ECF', 'D2E1E8', 'b4313d',
                     '95ca54']

  LEGEND_HEIGHT = 180#90
  ...
  def MakeEngagementImage(self):
    ...
    # The image title.
    self.IMG_TITLE = '"Engagement" for sciencenow.sciencemag.org'
    ...
    self.segments = (
      ...
      ('Visits From GHP', 'dynamic::ga:source=~sciencemag'),
      ('Visits From Stumbleupon', 'dynamic::ga:source=~stumbleupon'),
      ('Visits From Google', 'dynamic::ga:source=~google'),
      ('Visits From Slashdot', 'dynamic::ga:source=~slashdot'))
