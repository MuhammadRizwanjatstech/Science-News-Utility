...
user_api_key = 'sgf7NKCcxNJwFqoFW53idFFSL5b4XzCQe7lzmX7UgShE3E7TrYGBjNxhzNTE1IBR' # your disqus account api key
...
def main():
	...
	#dsq.set_debug(1)
	dsqforum = dsq.get_forum_list()[forum_index] # science magazine news (PRODUCTION)
